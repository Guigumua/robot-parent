package com.github.guigumua.robot.starter.test;
...
public class CodeGenerator {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://139.9.197.197:3306/qqbot?useUnicode=true&useSSL=false&characterEncoding=utf-8");
		...
		pc.setParent("com.wymc.demo.robot.bean");
		pc.setEntity("entity");
