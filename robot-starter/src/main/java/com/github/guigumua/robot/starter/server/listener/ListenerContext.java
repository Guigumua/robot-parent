...
public class ListenerContext {
	...
	public void setParamsMap(Map<Integer, Parameter> paramsMap) {
	...
	public void setMappingFilters(ArrayList<MappingFilter> mappingFilters) {
	...
	public void setPreFilters(ArrayList<PreFilter> preFilters) {
	...
	public void setPostFilters(ArrayList<PostFilter> postFilters) {
